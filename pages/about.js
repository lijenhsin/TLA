      ...
      <SectionTitle pretitle="Organization" title="學會章程">
        ...
        <div className={`text-left leading-9  ${MingTi.className}`}>
          ...
          <div className="text-md pl-24 -indent-24 whitespace-pre-line">
            ...
            <p>第　二　條　本會為依法設立、非以營利為目的之公益性社會團體，以推動國內喉科學、睡眠外科、吞嚥上呼吸消化道外科領域之持續精進，進而提升醫療服務品質、促進病人福祉為宗旨。{" "}
            </p>
            ...
            <p>第　六　條　本會會址設於主管機關所轄地區，並得報經主管機關核准設分支機構。
          ...
          <li>  一、個人會員：凡贊同本會宗旨且具有中華民國耳鼻喉科專科醫師資格者，填具入會申請書，經理事會審查通過，並繳納會費後，為個人會員。</li>
          
          <li>二、相關會員：凡贊同本會宗旨且具有中華民國醫師資格者，填具入會申請書，經理事會審查通過，並繳納會費後，為相關會員。相關會員經取得中華民國耳鼻喉科專科醫師資格者，得經理事會審查通過後，取得個人會員資格。</li>
          ...
          <ul className="ml-10"><li>（一）對喉科學相關領域有特殊貢獻者。</li>
          <li>（二）對本會會務有特殊貢獻者。</li></ul> 
          </li>
          ...
          第 十四 條　會員有下列情事之一者，為出會： </p><p>
          　一、死亡。
          </p><p>
          　二、喪失會員資格者。</p><p>
          　三、經會員（會員代表）大會決議除名者。 </p><p>
          ...
          </p><p>　<h2 className="text-black text-2xl mb-5">第四章　會議</h2>
          ...
          </p>　 <h2 className="text-black text-2xl mb-5">第五章　經費及會計 </h2>
          <p> 第三十三條　本會經費來源如下：</p>
          <p>
